...
m2 = model("weights/best_week9_final.pt")

image_1 = Image.open("images/1678943833.147846.jpg")
...
for image in images:
    ...
    im1 = image_handling.draw_bbox(
        image_handling.np_array_to_image(np_image), result_array_m1
    )
    im2 = image_handling.draw_bbox(
        image_handling.np_array_to_image(np_image), result_array_m2
    )
    model_1.append(im1)
    model_2.append(im2)
